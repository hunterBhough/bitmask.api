...
func NewGoDogeAPI(spec *loads.Document) *GoDogeAPI {
	return &GoDogeAPI{
		...
		GetRecordsHandler: GetRecordsHandlerFunc(func(params GetRecordsParams) middleware.Responder {
...
type GoDogeAPI struct {
	...
	// GetRecordsHandler sets the operation handler for the get records operation
...
func (o *GoDogeAPI) Validate() error {
	...
	if o.GetRecordsHandler == nil {
		unregistered = append(unregistered, "GetRecordsHandler")
	}
...
func (o *GoDogeAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/getRecords"] = NewGetRecords(o.context, o.GetRecordsHandler)
